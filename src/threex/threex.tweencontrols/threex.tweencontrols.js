...
/**
 * a controls which allows tweening on position/quaternion/scale
 *
 * @class
 * @param  {THREE.Object3D} object3d - the object3d which will be controlled
 */
THREEx.TweenControls	= function(object3d){
	...
	/**
	 * default tween function. replace it by the one you like
	 * - for a full list, see tween.js TWEEN.Easing in https://github.com/sole/tween.js/blob/master/src/Tween.js
	 * 
	 * @param  {Number} progress - progress number between 0 and 1 included
	 ...
	 * @param  {THREE.Quaternion=} newQuaternion - the new quaternion
	 * @param  {THREE.Vector3=} newScale      - the new scale
	 */
